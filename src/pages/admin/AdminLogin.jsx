  ...
  const handleDemoSetup = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        const dummyProducts = [
          {
            ...
            description:
              "Experience the pinnacle of cleaning technology. High density microfibre.",
            basePrice: 499,
            category: "Screen",
            images: [
              "https://images.unsplash.com/photo-1616400619175-5beda3a17896?auto=format&fit=crop&q=80&w=1000",
            ],
            variants: [
              {
                id: "v1_1",
          ...
          },
          {
            ...
            category: "Glass",
            images: [
              "https://images.unsplash.com/photo-1528740561666-dc24705f08a7?auto=format&fit=crop&q=80&w=1000",
            ],
            variants: [
              {
                id: "v2_1",
          ...
          },
          {
            ...
            category: "Lens",
            images: [
              "https://images.unsplash.com/photo-1626573867623-28688439366e?auto=format&fit=crop&q=80&w=1000",
            ],
            variants: [
              {
                id: "v3_1",
        ...
        alert(
          "Success! Account created and products seeded. Logging you in...",
        );
  ...
  const handleForceSeed = async () => {
    ...
    try {
      ...
      setError(
        "Force Seed failed: " +
          err.message +
          ". You might need to set Firestore Rules to 'allow write: if true' in Firebase Console.",
      );
    } finally {
      setLoading(false);
    }
